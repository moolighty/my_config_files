...
function! <SID>GetDoxFileHeader(leading_blank)
	...
	let doc = ""
  let doc = doc. a:leading_blank."/***************************************************************************\n"
  let doc = doc. a:leading_blank." * Copyright (c) ".<SID>GetYear()."  The AppsMoto Authors \n"
  let doc = doc. a:leading_blank." * ZingFront.com, Inc. All Rights Reserved \n"
  let doc = doc. a:leading_blank." **************************************************************************/\n"
  let doc = doc. a:leading_blank." \n"
  let doc = doc. a:leading_blank."/**\n"
...
autocmd FileType c,cpp,java,sh,awk,vim,sed,perl,python,php,js nnoremap <silent> <Leader>a :call <SID>GetDoxFH(0)<CR>
autocmd FileType c,cpp,java,sh,awk,vim,sed,perl,python,php,js nnoremap <silent> <Leader>s :call <SID>GetDoxFH(1)<CR>
autocmd FileType c,cpp,java,sh,awk,vim,sed,perl,python,php,js nnoremap <silent> <Leader>d :call <SID>GetDoxFH(2)<CR>
autocmd FileType c,cpp,java,sh,awk,vim,sed,perl,python,php,js nnoremap <silent> <Leader>f :call <SID>GetDoxFH(3)<CR>
...
autocmd BufNewFile *.js :call <SID>InsertJSHead()
